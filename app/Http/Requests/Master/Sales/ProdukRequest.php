...
class ProdukRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'master_produk_name'=>'required|unique:master_produk',
            'master_produk_deskripsi'=>'required',
            'master_produk_price'=>'required',
            'master_produk_file'=>'required|mimes:jpg,jpeg,png|max:5120|min:10',
        ];
    }
    ...
    public function attributes()
    {
        return [
            ...
            'master_produk_deskripsi'=>'Deskripsi Produk',
